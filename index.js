...
function upgradeConfig(configPath) {
  ...
  Module.prototype.require = function(moduleName) {
    return options => ({ _require: moduleName, _options: options  })
  }
  ...
  // TODO: options resulting config by removing
  // option values which match new defaults
  ...
  return 'module.exports = ' + output.replace("'%%PLUGINS%%'", '[' + _.join(strings) + ']');
}
